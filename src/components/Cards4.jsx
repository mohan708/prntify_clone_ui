    ...
    <div className='bg-[#F7F7F7] mb-28'>
      ...
      <div className=' pt-10 pb-8 bg-white w-[500px]   rounded-2xl   px-12 '>
          <div className='flex bg-white gap-6 text-start'>
            ...
            <p className='text-start pt-7 pb-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis quos dolorem odit reiciendis saepe eum dolor perspiciatis ab laboriosam dolores accusamus rem ex vitae quo assumenda ratione maiores, iusto commodi.</p>
      </div>
