...
<div className='py-20 max-w-[1216px] mx-auto px-6 '>
...
<div>
     <div>
        <h1 className='font-bold text-4xl pb-6'>Connect your store</h1>
   ...
   <img src="/public/symbol/sss.png" className='w-28 shadow-custom-360 absolute right-[1px] rounded-xl top-[58px] transition-transform duration-300 ease-in-out hover:scale-110' alt="" />
    ...
    <img src="/public/symbol/Printify.png" className='shadow-custom-360 absolute  rounded-2xl  top-[130px] left-[535px]  w-[150px]  ml-2 mb-2 transition-transform duration-300 ease-in-out hover:scale-110' alt="" /> 
...
<div className='  py-32 max-w-[1216px] mx-auto' >
   <div className='bg-green-200 py-16 px-8 rounded-2xl w-[100%] items-center flex justify-between' >

   <h3 className='text-green-600 pl-32 max-w-[45%] font-bold text-2xl text-start'>Are you a large business looking  for custom solutions?</h3>
   <button className='bg-white rounded  px-6 py-1 text-center mr-44'> Talk to sales </button>
   </div>
</div> 
   </>
  )
